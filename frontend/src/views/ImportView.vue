    ...
    <section class="import-step">
      ...
      <div v-if="step1Preview" class="import-preview">
        ...
        <div class="import-preview__actions">
          ...
          <button type="button" class="btn btn--secondary" :disabled="uploading || !step1File" @click="rotateStep1Image">90° drehen</button>
...
async function rotateStep1Image() {
  ...
  try {
    ...
    uploadError.value = e instanceof Error ? e.message : 'Bild konnte nicht gedreht werden'
  }
}
...
async function rotateStep2Image(idx: number) {
  ...
  try {
    ...
    extractError.value = e instanceof Error ? e.message : 'Bild konnte nicht gedreht werden'
  }
}
